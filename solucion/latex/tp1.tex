...
\begin{tad}{\tadNombre{Juego}}
    \tadGeneros{juego}
    \tadExporta{observadores, generadores, puntaje}
...
\begin{tad}{\tadNombre{Accion}}
    ...
    \tadOtrasOperaciones
        \tadOperacion{ubicacionLuegoDe}{accion,hab/h,ubicacion/u}{conj(pos)}{esValida?(h, pos(u))}
        \tadOperacion{posicionesAfectadasPor}{accion,hab/h,ubicacion/u}{conj(pos)}{esValida?(h, pos(u))}
    ...
    \tadAxiomas[\paratodo{nat}{n, m}, \paratodo{ubicacion}{u}, \paratodo{habitacion}{a}]
        ...
        \tadAxioma{posicionesAfectadasPor(disparar, h, u)}{
            ...
            {Ag(proxPosEnDir(dir(u), pos(u)), \\
                posicionesAfectadasPor(disparar, h, \\$\langle$proxPosEnDir(dir(u), pos(u)), dir(u)$\rangle$))}
            {$\emptyset$}
        }
